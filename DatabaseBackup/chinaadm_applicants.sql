...
--
-- Host: localhost:3306
-- Generation Time: Jul 11, 2018 at 08:27 AM
...
(98, 'LUSE MICHELO ', '18607090075', 'ZAMBIAN ', 'lpmichelo@gmail.com'),
(99, 'Hanif', '03135050156', 'Pakistan ', 'haniftayyab@hotmail.com');
...
--
ALTER TABLE `applications`
  MODIFY `applicantid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
COMMIT;
