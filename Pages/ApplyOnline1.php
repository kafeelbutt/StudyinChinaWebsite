...
<title>
Apply Online Unsuccessfully - Dar-UL-Ehsan Study Advisors
</title>
...
<script type="text/javascript" src="../JavaScript/public.js"></script>
		<script>alert('Apply online unsuccessfully!')</script>
		<div class="content">
	<div class="article">
	<div id="form_id">
	<h1>Apply Online Unsuccessfully</h1>
		<a href="../Pages/ApplyOnline.php" style="font-size:20px;">Click here to go back</a>
		</div>
		</div>
		</div>
			<div class="foot w">
