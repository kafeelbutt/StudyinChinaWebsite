...
<title>
Welcome Admin - Dar-UL-Ehsan Study Advisors
</title>
...
<script type="text/javascript" src="../JavaScript/public.js"></script>
	...
	<div class="article">
	<div id="form_id">
	<h1 style="color:white;text-shadow:5px 4px 8px white"> Hello <?php echo $_SESSION['username']; ?>, </h1>
	<a href="../Pages/ViewList.php" style="font-size:20px; "> View Student Records </a>
	<a href="../Pages/Delete.php" style="font-size:20px; "> Delete Student Records </a>
